...
export const animals: Record<AnimalKey, Animal> = {
  ...
  sheep: {
    ...
    key: 'sheep',
    name: '網紅綿羊',
    image: `${base}images/animal10.png`,
    rarity: 'superrare',
    portfolio: 'hot_theme',
